...
exports.ParsianGoverment = void 0;
const soap = require("soap");
const driver_1 = require("../../driver");
const exceptions_1 = require("../../exceptions");
const API = require("./api");
class ParsianGoverment extends driver_1.Driver {
    constructor(config) {
        ...
        this.requestPayment = async (options) => {
            ...
            const response = await client.SalePaymentRequestAsync({ requestData: requestFields });
        ...
        this.verifyPayment = async (_options, params) => {
            ...
            const verifyResponse = await soapClient.ConfirmPaymentAsync({ requestData: requestFields });
            ...
            if (!(Status.toString() === '0' && RRN > 0)) {
                ...
                const reversalResponse = await soapClient.ReversalRequestAsync({ requestData: reversalRequestFields });
...
exports.ParsianGoverment = ParsianGoverment;
