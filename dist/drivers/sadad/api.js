...
exports.tVerifyOptions = exports.tRequestOptions = exports.tConfig = exports.verifyErrors = exports.requestErrors = exports.tMultiplexingObject = exports.tMultiplexingRow = exports.links = void 0;
...
exports.requestErrors = {
    ...
    '1012': 'اطالعات پذيرنده صحیح نیست،يکی از موارد تاريخ،زمان يا کلید تراکنش اشتباه است.لطفا مسئول فنی پذيرنده با بانک تماس حاصل فرمايند',
    ...
    '1030': 'آدرس Domain پرداخت در محدوده آدرس های معتبر اعالم شده توسط پذيرنده نیست .لطفا مسئول فنی پذيرنده با بانک تماس حاصل فرمايند',
...
exports.tRequestOptions = t.intersection([
    ...
    t.partial({
        mobile: t.string,
        multiplexingData: exports.tMultiplexingObject,
        appName: t.string,
    }),
]);
